...
export default function SubastaDetallePage() {
  ...
  const imgUrl = subasta.imagen
    ...
    : null;
  const categorias = subasta.categorias ? subasta.categorias.split(", ") : [];
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="bg-white rounded-lg shadow p-6 text-[#1f1f1f]">
            ...
            <p className="mb-3">
              ...
              >
                {parseDate(subasta.fecha_inicio)?.toLocaleString() ||
                  "No disponible"}
              </span>
            </p>
            ...
            <p className="mb-3">
              ...
              >
                {parseDate(subasta.fecha_fin)?.toLocaleString() ||
                  "No disponible"}
              </span>
            </p>
                ...
                pujas.map((p) => (
                  <tr key={p.id_puja} className="border-b border-gray-100">
                    ...
                    <td
                      ...
                      style={{ fontFamily: "Montserrat, sans-serif" }}
                    >
                      {parseDate(p.fecha_hora)?.toLocaleString() ||
                        "No disponible"}
                    </td>
                  </tr>
                ))
