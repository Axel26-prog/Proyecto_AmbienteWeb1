...
export default function SubastasAdminPage() {
  ...
  const abrirModalCrear = async () => {
    ...
    setModalCrear(true);
    try {
      const [relojes, u] = await Promise.all([
        getRelojes(),
    ...
    <div className="bg-gray-100 min-h-screen font-[Montserrat]">
      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-3xl font-bold text-[#845b34]" style={{ fontFamily: "Georgia" }}>
            {esVendedor ? "Mis Subastas" : "Administración de Subastas"}
          </h1>
          <button
                    ...
                    <tr key={s.id_subasta} className="border-t border-[#845b34]/20 align-top">
                      ...
                      <td className="p-3">
                        <div className="flex flex-col gap-2 min-w-[120px]">
                          ...
                          {/* Editar y Cancelar — solo Administrador */}
                          {esAdministrador && (
                            <>
                              <div>
                                <button
